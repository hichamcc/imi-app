...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Set to true to embed ONLY the glyphs actually used in the PDF — typically
         * shrinks payslip/contract PDFs from ~860 KB to ~70 KB while keeping full
         * Unicode support (€, accented names, etc.).
         */
